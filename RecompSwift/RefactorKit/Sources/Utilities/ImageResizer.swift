...
#else
    /// watchOS does not provide `UIGraphicsImageRenderer`; callers should avoid image upload paths or pre-encode JPEG data on iOS.
    public static func resizeForAPI(_ image: UIImage) -> Data? { nil }

    public static func resizeForAvatar(_ image: UIImage) -> Data? { nil }
#endif
}
#endif
