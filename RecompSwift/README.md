...
| `RecompWatch/App/` + `RecompWatch/Features/` | Watch app target |
| `RecompWatch/Complications/` | Widget extension target |

### 4. Configure Capabilities

#### iOS App Target
- **App Groups**: `group.com.recomp.ios`
- **Push Notifications**: Enable
- **HealthKit**: Enable
- **Background Modes**: Background fetch, Remote notifications

#### Watch App Target
- **App Groups**: `group.com.recomp.ios` (same group)
- **HealthKit**: Enable
